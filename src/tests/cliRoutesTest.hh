...
final class cliRoutesTest extends \PHPUnit_Framework_TestCase {
    private $baseRoute;
    ...
    public function setUp() {
        ...
        $this->newSoftwareConfigUrl = 'http://code.irestful.com/configs/softwares/apis/cli_routes.json';
        ...
        $this->containerData = getCLIRoutesContainerData();
        $this->data = array(
            'first' => getCliRouteData($restAPIData, 0),
            'second' => getCliRouteData($restAPIData, 1)
        );
    }
